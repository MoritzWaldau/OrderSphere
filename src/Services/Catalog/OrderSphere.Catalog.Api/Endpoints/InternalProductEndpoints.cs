...
{
    public static void MapInternalProductEndpoints(this IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/internal/products");
        ...
        CancellationToken ct)
    {
        ...
        var result = names.ToDictionary(p => p.Id, p => p.Name);
